...
# подобрано по 3-й, 5-й и 7-й гармоникам из Э10: RAT с точностью 0.2 дБ, TS — 2.7 дБ (модель без памяти не учитывает «горб» TS)
ИСКАЖЕНИЯ = {"TS100": (0.739, 1.53), "RAT100": (0.491, 3.61)}
